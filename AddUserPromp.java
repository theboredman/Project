...
public class AddUserPromp implements Initializable {
    ...
    private ManageUserProfile manageUserProfile; // Add this line to declare the manageUserProfile variable
    ...
    private void handleRegisterButtonAction(ActionEvent event) {
        ...
        userInputs(id, userName, department, email, phoneNumber, passedCredit, cgpa, password, filePath);
    }

    private void userInputs(String id, String userName, String department, String email, String phoneNumber, String passedCredit, String cgpa, String password, String filePath) {
        ...
        try {
            ...
            // Move profile picture to user directory if available
            if (selectedImageFile != null) {
    ...
    private void handleUploadImage() {
        ...
        if (selectedFile != null) {
            try {
                File profilePicturesDirectory = new File("profile_pictures");
                if (!profilePicturesDirectory.exists()) {
                    profilePicturesDirectory.mkdir();
                }

                String newFileName = getId() + ".jpg"; // Assuming the file will be saved as a JPG
                File newFile = new File(profilePicturesDirectory, newFileName);
